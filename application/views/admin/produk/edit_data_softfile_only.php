    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">Edit Data Soft File Only</h1>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/produk/kategori_produk/soft_file_only/') ?>">Soft File Only</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Data Soft File Only</li>
                    </ol>
                    ...
                    <div class="col-xl-12 col-lg-12">
                        ...
                        <div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
                            <div class="mt-2 mb-4">
                                ...
                                <form action="<?= base_url('admin/produk/edit_data_softfile_only_aksi') ?>" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Nama <span class="text-red">*</span></label>
                                                    <input type="hidden" name="id_softfile_only" value="<?= $row->id_softfile_only ?>">
                                                    <input type="text" name="nama_softfile_only" class="form-control" value="<?= $row->nama_softfile_only ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Variasi <span class="text-red">*</span></label>
                                                    <input type="text" name="variasi_softfile_only" class="form-control" value="<?= $row->variasi_softfile_only ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Harga <span class="text-red">*</span></label>
                                                    <input type="number" name="harga_softfile_only" class="form-control" value="<?= $row->harga_softfile_only ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Diskon <span class="text-red">*</span></label>
                                                    <input type="number" name="diskon_softfile_only" class="form-control" value="<?= $row->diskon_softfile_only ?>" placeholder="Diskon">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="deskripsi_softfile_only" class="content" cols="0" rows="3" ><?= $row->deskripsi_softfile_only ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Thumbnail<span class="text-red">*</span></label>
                                                    <input type="file" name="gambar_softfile_only" class="form-control" value="<?= set_value('gambar_softfile_only') ?>"> 
