    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">Tambah Data Print Only</h1>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/produk/kategori_produk/print_only/') ?>">Print Only</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Tambah Data Print Only</li>
                    </ol>
            ...
            <div class="row row-cards">
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        ...
                        <form action="<?= base_url('admin/produk/tambah_data_print_only_aksi') ?>" method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="form-label">Nama <span class="text-red">*</span></label>
                                            <input type="text" name="nama_print_only" class="form-control" placeholder="Masukan Nama">
                                            <?= form_error('nama_print_only', '<small class="text-danger" style="color: red;">','</small>'); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="variasi_print_only" class="form-control" placeholder="Masukan Variasi">
                                            <?= form_error('variasi_print_only', '<small class="text-danger" style="color: red;">','</small>'); ?>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Dimensi <span class="text-red">*</span></label>
                                            <input type="text" name="dimensi_print_only" class="form-control" placeholder="Masukan Dimensi">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="harga_print_only" class="form-control" placeholder="Masukan Jumlah Harga">
                                            <?= form_error('variasi_print_only', '<small class="text-danger" style="color: red;">','</small>'); ?>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="diskon_print_only" class="form-control" placeholder="Masukan Jumlah Diskon">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="deskripsi_print_only" class="content" cols="0" rows="3" placeholder="Masukan Deskripsi"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="form-label">Thumbnail<span class="text-red">*</span></label>
                                            <input type="file" name="gambar_print_only" class="form-control" value="<?= set_value('gambar_print_only') ?>" required> 
