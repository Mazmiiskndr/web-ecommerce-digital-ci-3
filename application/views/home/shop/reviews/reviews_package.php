                ...
                <div class="col-lg-7 col-custom">
                    ...
                    <div class="product-summery position-relative">
                        ...
                        <div class="product-meta mb-5">
                            ...
                            <div class="product-metarial">
                                <span>Variasi :</span>
                                <a href=""><strong><?= $row->variasi_package ?></strong></a>
                            </div>
                            <!-- Product Metarial End -->
                        </div>
                        <!-- Product Meta End -->
                       ...
                       <!-- Product Meta End -->
                       <hr>
                       <form action="<?= base_url('home/shop/tambah_reviews_package/') ?>" method="post">
                        <h4>Add a reviews</h4>
                        <div class="row mb-2">
                            ...
                            <div class="col">
                                ...
                                <input type="hidden" name="id_package" value="<?= $row->id_package ?>" readonly>
