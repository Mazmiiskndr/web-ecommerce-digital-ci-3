                    ...
                    <div class="product-summery position-relative">
                        ...
                        <div class="product-meta mb-5">
                            ...
                            <div class="product-meta mb-5">
                                ...
                                <div class="product-metarial">
                                    <span>Variasi :</span>
                                    <a href=""><strong><?= $row->variasi_print_only ?></strong></a>
                                </div>
                                <!-- Product Metarial End -->
                            </div>
                            <!-- Product Meta End -->
                        ...
                        <hr>
                        <form action="<?= base_url('home/shop/tambah_reviews_print_only/') ?>" method="post">
                            <h4>Add a reviews</h4>
                            <div class="row mb-2">
                                ...
                                <div class="col">
                                    ...
                                    <input type="hidden" name="id_print_only" value="<?= $row->id_print_only ?>" readonly>
