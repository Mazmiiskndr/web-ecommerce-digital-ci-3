                    ...
                    <div class="product-details-img">
                        ...
                        <div class="single-product-img swiper-container gallery-top">
                            <div class="swiper-wrapper popup-gallery">
                                <a class="swiper-slide w-100" href="<?= base_url('assets/uploads/print_only/'.$row->gambar_print_only) ?>">
                                    <img class="w-100" src="<?= base_url('assets/uploads/print_only/'.$row->gambar_print_only) ?>" alt="Product">
                                </a>

                                <a class="swiper-slide w-100" href="<?= base_url('assets/uploads/print_only/'.$row->gambar1_print_only) ?>">
                                    <img class="w-100" src="<?= base_url('assets/uploads/print_only/'.$row->gambar1_print_only) ?>" alt="Product">
                                </a>

                                <a class="swiper-slide w-100" href="<?= base_url('assets/uploads/print_only/'.$row->gambar2_print_only) ?>">
                                    <img class="w-100" src="<?= base_url('assets/uploads/print_only/'.$row->gambar2_print_only) ?>" alt="Product">
                                </a>

                                <a class="swiper-slide w-100" href="<?= base_url('assets/uploads/print_only/'.$row->gambar3_print_only) ?>">
                                    <img class="w-100" src="<?= base_url('assets/uploads/print_only/'.$row->gambar3_print_only) ?>" alt="Product">
                                </a>
                        ...
                        <div class="single-product-thumb swiper-container gallery-thumbs">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="<?= base_url('assets/uploads/print_only/'.$row->gambar_print_only) ?>" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="<?= base_url('assets/uploads/print_only/'.$row->gambar1_print_only) ?>" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="<?= base_url('assets/uploads/print_only/'.$row->gambar2_print_only) ?>" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="<?= base_url('assets/uploads/print_only/'.$row->gambar3_print_only) ?>" alt="Product">
                                </div>
                            </div>
                ...
                <div class="col-lg-7 col-custom">
                    ...
                    <div class="product-summery position-relative">
                        ...
                        <div class="product-head mb-3">
                            <h2 class="product-title"><?= $row->nama_print_only ?></h2>
                        </div>
                        <!-- Product Head End -->
                        ...
                        <div class="price-box mb-2">
                            <?php if($row->diskon_print_only){ ?>
                                <span class="regular-price">Rp. <?= number_format($row->harga_print_only - $row->diskon_print_only,0,',','.'); ?></span>
                                <span class="old-price"><del>Rp. <?= number_format($row->harga_print_only,0,',','.'); ?></del></span>
                            <?php }else{ ?>
                                <span class="regular-price">Rp. <?= number_format($row->harga_print_only,0,',','.'); ?></span>
                            <?php } ?>
                        </div>
                        <!-- Price Box End -->
                        ...
                        <!-- Description Start -->
                        <p class="desc-content mb-5"><?= $row->deskripsi_print_only ?></p>
                        <!-- Description End -->

                        <form action="<?= base_url('home/cart/tambah_cart_print_only/'.$row->id_print_only) ?>" method="post">
                    ...
                    <div class="coupon-accordion">
                        <!-- Title Start -->
                        <h3 class="title"><span id="showcoupon"><strong><i class="fa fa-cube"></i> Packaging</span></strong></h3>
                        <!-- Title End -->
                        ...
                        <div id="checkout_coupon" class="coupon-checkout-content">
                            <div class="coupon-info">
                                <ul class="product-delivery-policy border-top pt-4 border-bottom pb-4">
                                    <?php foreach($packaging2 as $p){ ?>
                                        <li><span> - <?= $p->nama_packaging ?></span></li>
                                        <li><span><?= $p->deskripsi_packaging ?></span></li>
                                    <?php } ?>                           
                                </ul>
                            </div>
                        </div>
                    ...
                    <!-- <div class="social-share">
                        <span> <i class="fa fa-cube"></i> Packaging</span>
                    ...
                    <div class="tab-pane fade" id="connect-2" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="product_tab_content  border p-3">
                            ...
                            <?php foreach($reviews as $ulasan){ ?>
                                <?php if($row->id_print_only == $ulasan->id_print_only){ ?>
                                    <!-- Start Single Review -->
    ...
    <div class="col">
        <div class="product-carousel">
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <!-- Product Start -->
                    <?php foreach($print_only as $sp){ ?>
                        <?php if($sp->id_print_only != $row->id_print_only){ ?>
                            <div class="swiper-slide product-wrapper">

                                <!-- Single Product Start -->
                                <div class="product product-border-left mb-10" data-aos="fade-up" data-aos-delay="300">
                                    <div class="thumb">
                                        <a href="<?= base_url('home/shop/detail_print_only/'.$sp->slug_print_only) ?>" class="image">
                                            <img class="first-image" src="<?= base_url('assets/uploads/print_only/'.$sp->gambar_print_only) ?>" alt="Product" />
                                            <?php if($sp->gambar1_print_only){ ?>
                                                <img class="second-image" src="<?= base_url('assets/uploads/print_only/'.$sp->gambar1_print_only) ?>" alt="Product" />
                                            <?php }else{ ?>
                                                <img class="second-image" src="<?= base_url('assets/uploads/print_only/'.$sp->gambar_print_only) ?>" alt="Product" />
                                            <?php } ?>

                                        </a>
                                        <?php if($sp->diskon_print_only){ ?>
                                            <span class="badges">
                                                <span class="sale">-<?= round(($sp->diskon_print_only/$sp->harga_print_only)*100) ?>%</span>
                                            </span>
                                        <?php } ?>

                                    </div>
                                    <div class="content">
                                        <h4 class="sub-title"><a href="<?= base_url('home/shop/detail_print_only/'.$sp->slug_print_only) ?>"><?= $sp->nama_kategori_produk ?></a></h4>
                                        <h5 class="title"><a href="<?= base_url('home/shop/detail_print_only/'.$sp->slug_print_only) ?>"><?= $sp->nama_print_only ?></a></h5>
                                       <!--  <span class="ratings">
                                           <span class="rating-wrap">
                                            <span class="star" style="width: 100%"></span>
                                        </span>
                                    ...
                                    <span class="price">
                                        <span class="new"> Rp. <?= number_format($sp->harga_print_only - $sp->diskon_print_only,0,',','.'); ?></span>
                                        <?php if($sp->diskon_print_only){ ?>
                                            <span class="old">Rp. <?= number_format($sp->harga_print_only,0,',','.'); ?></span>
                                        <?php } ?>
                                    </span>
                                    <a href="<?= base_url('home/shop/detail_print_only/'.$sp->slug_print_only) ?>" class="btn btn-sm btn-outline-dark btn-hover-primary">Order Now</a>
                                </div>
                            </div>
                            <!-- Single Product End -->
