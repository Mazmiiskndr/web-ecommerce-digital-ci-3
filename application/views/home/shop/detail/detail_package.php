                    ...
                    <div class="product-details-img">
                        ...
                        <div class="single-product-img swiper-container gallery-top">
                            <div class="swiper-wrapper popup-gallery">
                                <a class="swiper-slide w-100" href="<?= base_url('assets/uploads/package/'.$row->gambar_package) ?>">
                                    <img class="w-100" src="<?= base_url('assets/uploads/package/'.$row->gambar_package) ?>" alt="Product">
                                </a>

                                <a class="swiper-slide w-100" href="<?= base_url('assets/uploads/package/'.$row->gambar1_package) ?>">
                                    <img class="w-100" src="<?= base_url('assets/uploads/package/'.$row->gambar1_package) ?>" alt="Product">
                                </a>

                                <a class="swiper-slide w-100" href="<?= base_url('assets/uploads/package/'.$row->gambar2_package) ?>">
                                    <img class="w-100" src="<?= base_url('assets/uploads/package/'.$row->gambar2_package) ?>" alt="Product">
                                </a>

                                <a class="swiper-slide w-100" href="<?= base_url('assets/uploads/package/'.$row->gambar3_package) ?>">
                                    <img class="w-100" src="<?= base_url('assets/uploads/package/'.$row->gambar3_package) ?>" alt="Product">
                                </a>
                        ...
                        <div class="single-product-thumb swiper-container gallery-thumbs">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="<?= base_url('assets/uploads/package/'.$row->gambar_package) ?>" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="<?= base_url('assets/uploads/package/'.$row->gambar1_package) ?>" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="<?= base_url('assets/uploads/package/'.$row->gambar2_package) ?>" alt="Product">
                                </div>
                                <div class="swiper-slide">
                                    <img src="<?= base_url('assets/uploads/package/'.$row->gambar3_package) ?>" alt="Product">
                                </div>
                            </div>
                ...
                <div class="col-lg-7 col-custom">
                    ...
                    <div class="product-summery position-relative">
                        ...
                        <div class="product-head mb-3">
                            <h2 class="product-title"><?= $row->nama_package ?></h2>
                        </div>
                        <!-- Product Head End -->
                        ...
                        <div class="price-box mb-2"> 
                            <!-- <?php if($row->diskon_package){ ?>
                                <span class="regular-price">Rp. <?= number_format($row->harga_package - $row->diskon_package,0,',','.'); ?></span>
                                <span class="old-price"><del>Rp. <?= number_format($row->harga_package,0,',','.'); ?></del></span>
                            <?php }else{ ?>
                                <span class="regular-price">Rp. <?= number_format($row->harga_package,0,',','.'); ?></span>
                                <?php } ?> -->
                                <span class="regular-price">Rp. <?= number_format(($row->harga_package - $row->diskon_package) + $row->harga_terendah + $harga_packaging['harga_terendah_packaging'],0,',','.'); ?> 
                                -
                                Rp. <?= number_format(($row->harga_package - $row->diskon_package) + $row->harga_tertinggi + $harga_packaging['harga_tertinggi_packaging'],0,',','.'); ?></span>
                            </div>
                            <!-- Price Box End -->
                            ...
                            <!-- Description Start -->
                            <p class="desc-content mb-5"><?= $row->deskripsi_package ?></p>
                            <!-- Description End -->



                            <form action="<?= base_url('home/cart/tambah_cart_package/'.$row->id_package) ?>" method="post">
                                <div class="row mb-6">
                                    <div class="col">
            ...
            <div class="tab-pane fade" id="connect-2" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <div class="product_tab_content  border p-3">
                    <?php foreach($reviews as $ulasan){ ?>
                        <?php if($row->id_package == $ulasan->id_package){ ?>
                            <!-- Start Single Review -->
    ...
    <div class="col">
        <div class="product-carousel">
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <!-- Product Start -->
                    <?php foreach($package as $sp){ ?>
                        <?php if($sp->id_package != $row->id_package){ ?>
                            <div class="swiper-slide product-wrapper">

                                <!-- Single Product Start -->
                                <div class="product product-border-left mb-10" data-aos="fade-up" data-aos-delay="300">
                                    <div class="thumb">
                                        <a href="<?= base_url('home/shop/detail_package/'.$sp->slug_package) ?>" class="image">
                                            <img class="first-image" src="<?= base_url('assets/uploads/package/'.$sp->gambar_package) ?>" alt="Product" />
                                            <?php if($sp->gambar1_package){ ?>
                                                <img class="second-image" src="<?= base_url('assets/uploads/package/'.$sp->gambar1_package) ?>" alt="Product" />
                                            <?php }else{ ?>
                                                <img class="second-image" src="<?= base_url('assets/uploads/package/'.$sp->gambar_package) ?>" alt="Product" />
                                            <?php } ?>

                                        </a>
                                        <?php if($sp->diskon_package){ ?>
                                            <span class="badges">
                                                <span class="sale">-<?= round(($sp->diskon_package/$sp->harga_package)*100) ?>%</span>
                                            </span>
                                        <?php } ?>
                                    </div>
                                    <div class="content">
                                        <h4 class="sub-title"><a href="<?= base_url('home/shop/detail_package/'.$sp->slug_package) ?>"><?= $sp->nama_kategori_produk ?></a></h4>
                                        <h5 class="title"><a href="<?= base_url('home/shop/detail_package/'.$sp->slug_package) ?>"><?= $sp->nama_package ?></a></h5>
                                       <!--  <span class="ratings">
                                           <span class="rating-wrap">
                                            <span class="star" style="width: 100%"></span>
                                        </span>
                                    ...
                                    <span class="price">
                                        <span class="new"> Rp. <?= number_format($sp->harga_package - $sp->diskon_package,0,',','.'); ?></span>
                                        <?php if($sp->diskon_package){ ?>
                                            <span class="old">Rp. <?= number_format($sp->harga_package,0,',','.'); ?></span>
                                        <?php } ?>
                                    </span>
                                    <a href="<?= base_url('home/shop/detail_package/'.$sp->slug_package) ?>" class="btn btn-sm btn-outline-dark btn-hover-primary">Order Now</a>
                                </div>
                            </div>
                            <!-- Single Product End -->
