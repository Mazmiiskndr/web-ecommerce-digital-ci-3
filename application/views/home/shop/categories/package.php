                ...
                <div class="shop_toolbar_wrapper flex-column flex-md-row mb-10">
                    ...
                    <div class="shop-top-bar-left mb-md-0 mb-2">
                        <div class="shop-top-show">
                            <span>Showing 1 – <?= $jumlah_package ?> results</span>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product" data-aos="fade-up" data-aos-delay="200">
                            <div class="product-inner">
                                <div class="thumb">
                                    ...
                                    <?php } ?>
                                    <div class="actions">
                                        <a href="<?= base_url('home/shop/detail_package/'.$p->slug_package) ?>" class="action compare"><i class="fa fa-eye"></i></a>
                                    </div>
                                </div>
                                <div class="content">
            ...
            <aside class="sidebar_widget mt-10 mt-lg-0">
                <div class="widget_inner" data-aos="fade-up" data-aos-delay="200">
                    <div class="widget-list mb-10">
                        <form action="<?= base_url('home/shop/search_package') ?>" method="post">
                            <h3 class="widget-title mb-4">Search</h3>
                            <div class="search-box">
                                <input type="text" class="form-control" name="keyword_package" placeholder="Search..." aria-label="Search Our Store">
                        ...
                        <nav>
                            <ul class="category-menu mb-n3">
                                <?php foreach($kategori_produk as $kp){ ?>
                                    <?php if($kp->slug_kategori_produk != "package"){ ?>
