                                        ...
                                        <?php if($produk_transaksi){ ?>
                                            ...
                                            <?php }else{ ?>
                                                ...
                                                <?php foreach($upload as $upload){ ?>
                                                    <div class="myaccount-content">
                                                        <h3 class="title">Upload Bukti Retur</h3>
                                                        <div class="account-details-form">
                                                            <form action="<?= base_url('home/profil/retur_aksi') ?>" method="post" enctype="multipart/form-data">

                                                                <div class="single-input-item mb-3">
                                                                    <label class="required mb-1">Upload </label>
                                                                    <small class="text-danger">Upload bukti retur harus berupa Video/MP4!</small>
                                                                    ...
                                                                    <input type="file" placeholder="Upload Bukti Retur" name="file_retur" value="<?= set_value('file_retur') ?>" required />
                                                                </div>
